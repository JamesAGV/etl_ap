...
class etl_ap: 
    ...
    def format_bytes(self, array_bytes):
        formated_data = self.get_LReal(5, 0, array_bytes) + self.get_DInt(1, 40, array_bytes) + self.get_UInt(1, 44, array_bytes) + self.get_Byte(5, 46, array_bytes) + self.get_UInt(8, 52, array_bytes) +  self.get_Real(12, 68, array_bytes) + self.get_UInt(5, 116, array_bytes) + self.get_Byte(3, 126, array_bytes) + self.get_UInt(1, 130, array_bytes) + self.get_Real(2, 132, array_bytes) + self.get_Byte(3, 140, array_bytes) + self.get_UInt(1, 144, array_bytes) + self.get_Real(2, 146, array_bytes) + self.get_Byte(3, 154, array_bytes) + self.get_UInt(1, 158, array_bytes) + self.get_Real(2, 160, array_bytes) + self.get_Byte(3, 168, array_bytes) + self.get_UInt(1, 172, array_bytes) + self.get_Real(2, 174, array_bytes) + self.get_Byte(3, 182, array_bytes) + self.get_UInt(1, 186, array_bytes) + self.get_Real(2, 188, array_bytes) + self.get_Byte(3, 196, array_bytes) + self.get_UInt(1, 200, array_bytes) + self.get_Real(2, 202, array_bytes) + self.get_Byte(3, 210, array_bytes) + self.get_UInt(1, 214, array_bytes) + self.get_Real(2, 216, array_bytes) + self.get_Byte(3, 224, array_bytes) + self.get_UInt(1, 228, array_bytes) + self.get_Real(2, 230, array_bytes) + self.get_Byte(3, 238, array_bytes) + self.get_UInt(1, 242, array_bytes) + self.get_Real(2, 244, array_bytes) + self.get_Byte(3, 252, array_bytes) + self.get_UInt(1, 256, array_bytes) + self.get_Real(2, 258, array_bytes)
